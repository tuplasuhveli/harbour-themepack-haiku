    ...
    SilicaFlickable
    {
        ...
        Column
        {
            ...
            SectionHeader { text: qsTr("Disclaimer") }
                LabelText {
                    text: qsTr("This theme pack is inspired by Haiku® aesthetics; it is an independent project by UI Themer. This project is not affiliated with or endorsed by %1. Haiku® and HAIKU Leaf™ are trademarks of Haiku, Inc. See %2.")
                        .arg("<a href=\"https://www.haiku-inc.org/\">Haiku, Inc.</a>")
                        .arg("<a href=\"https://www.haiku-inc.org/trademarks.html\">Haiku Inc. trademarks</a>")
                }
